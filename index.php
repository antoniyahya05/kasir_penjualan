      ...
      <div class="col-md-5 col-md-offset-3">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h2>
              <Toko><span class="glyphicon glyphicon-book" aria-hidden="true"></span> Toko Buku
            </h2>
            <h3>Login System</h3>
            <p><span class="glyphicon glyphicon-road" aria-hidden="true"></span> Jln.Kh achmad fauzan no 001, Jepara</p>
            </h2>
          </div>
          <div class="panel-body">
            ...
            <form action="" method="post">
              ...
              <br>
              <div>
                <input type="submit" name="flogin" class="btn btn-info btn-block" value="Login">
                <?php
